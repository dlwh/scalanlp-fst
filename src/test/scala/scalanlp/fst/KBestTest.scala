...
class KBestTest extends FunSuite {
  import Automaton._;
  test("Simple KBest") {
//    implicit val h = KBest.aStarHeuristic[scalanlp.fst.Automaton[Double,Either[Either[Int,Int],Int],Char],scalanlp.fst.Automaton[Double,Either[Either[Int,Int],Int],Char],Double,Either[Either[Int,Int],Int],Char]
